            ...
            if($user && $user->isValid()) {
                if(!$user->isGuest()) {
                    $navs['tickets']=array('desc'=>sprintf(__('Tickets (%d)'),$user->getNumTickets($user->canSeeOrgTickets())),
                        ...
                        //Custom code for extra menu item
                        $navs['export_tickets'] = array('desc' => 'Export Tickets',
                                            'href' => 'client_front.php',
                                            'title' => __('Export Tickets'));
                        //End Custom code for extra menu item
                } else {
